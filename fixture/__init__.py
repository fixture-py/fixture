...
fixture provides an interface for loading tabular data into arbitrary storage media. You create generic !DataSet objects that can be loaded into a database, CSV file, XML file, or anything else suitable.  This is useful for testing and came about to solve problems like these:
